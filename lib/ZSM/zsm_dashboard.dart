...
class ZSMDashboard extends StatefulWidget {
  const ZSMDashboard({super.key});

  @override
  State<ZSMDashboard> createState() => _ZSMDashboardState();
}

class _ZSMDashboardState extends State<ZSMDashboard>
  ...
  Future<void> MarkAttendancewithDealershipID(
    ...
    print("UserIdhel: $userid");
    print("IsPresenthelhel: $marks");
    print("Reason: $reason");
    print("lath: $currentlat");
    print("lngh: $currentlng");
    print("appDateTimehh: ${getCurrentDateTime()}");
    print("dealershipIdhelo: $firstDealershipId");
