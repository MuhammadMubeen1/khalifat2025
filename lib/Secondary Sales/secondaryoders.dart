...
import 'package:KhilafatCola/order_confirmation/blinking.dart';
...
class _SupervisorOrderHistoryScreenState
  ...
  String selectedStatusId = 'all'; // Default to All tab
  ...
  Future<List<dynamic>> fetchAllDealershipData() async {
    final url =
        Uri.parse('http://202.166.160.200:9086/api/App/GetDealershipOrder');
    ...
    try {
      ...
      final body = {
        "OrderId": 0,
        "StatusId": 0,
        "FDate": "2024-08-05T05:40:44.828Z",
        "TDate": "2025-09-09T05:40:44.828Z",
        "DealershipId": 174,
        "AppDateTime": "2025-09-10T05:40:44.828Z",
        "PagingData": {"CurrentPage": 0, "Take": 10, "IsPagingEnabled": true}
      };
      ...
      if (response.statusCode == 200) {
        ...
        // Check if Data exists and has Item1
  ...
  // Original function for specific status
                ...
                children: [
                  for (int i = 0; i < statusIds.length; i++)
                    FutureBuilder<List<dynamic>>(
                      future: statusIds[i] == 'all'
                          ? fetchAllDealershipData()
                          : fetchDealershipData(statusIds[i]),
  ...
  Widget _buildOrderList(
      AsyncSnapshot<List<dynamic>> snapshot, String statusId) {
    if (snapshot.connectionState == ConnectionState.waiting) {
      ...
      // For the "All" tab, we need to handle the different data structure
      if (statusId == 'all') {
...
class AllOrderListItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    var orderDate = order['CreatedDate'];
    ...
    if (orderItems != null) {
      for (var item in orderItems) {
        ...
        double price = (item['DistributorPrice'] ?? 0).toDouble();
  ...
  children: [
    ...
    const SizedBox(width: 5), // spacing between text & icon
    const Icon(
                        ...
                        return Container(
                          ...
                          child: ClipRRect(
                            ...
                            child: Stack(
                              children: [
                                Image.network(
                                  'http://202.166.160.200:9085${attachment['FileSource']}',
                                  width: 100,
                                  height: 100,
                                  fit: BoxFit.cover,
                                  errorBuilder: (context, error, stackTrace) =>
                          ...
                          children: [
                            ...
                            product['Image'] != null &&
                                ...
                                ? ClipRRect(
                                    borderRadius: BorderRadius.circular(10),
                                    child: Image.network(
                                      'http://202.166.160.200:9085${product['Image']}',
                                      width: 60,
                                      height: 60,
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 12),
                  ...orderProcess.map((process) => Container(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Text(
                              formatDate(process['CreatedDate']),
                              style: TextStyle(
                                fontSize: 12,
